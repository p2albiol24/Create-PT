...
def save_game():
    ...
    saver.write(Room.save_deets(gym))
    saver.write(Room.save_deets(Intelligence))
    saver.write(Room.save_deets(maint))
    saver.write(Room.save_deets(server))
    saver.write(Room.save_deets(capbr))
    saver.write(Room.save_deets(offbr))
    saver.write(Room.save_deets(gpw1))
    saver.write(Room.save_deets(gpw2))
    saver.write(Room.save_deets(gpe1))
    saver.write(Room.save_deets(gpe2))
    saver.write(Room.save_deets(bed2))
    saver.write(Room.save_deets(bed3))
    saver.write(Room.save_deets(bed4))
    saver.write(Room.save_deets(bed5))
...
def open_save_file():
    ...
    gym.set_description(content[53])
    gym.set_save(content[54])
    Intelligence.set_description(content[55])
    Intelligence.set_save(content[56])
    maint.set_description(content[57])
    maint.set_save(content[58])
    server.set_description(content[59])
    server.set_save(content[60])
    capbr.set_description(content[61])
    capbr.set_save(content[62])
    offbr.set_description(content[63])
    offbr.set_save(content[64])
    gpw1.set_description(content[65])
    gpw1.set_save(content[66])
    gpw2.set_description(content[67])
    gpw2.set_save(content[68])
    gpe1.set_description(content[69])
    gpe1.set_save(content[70])
    gpe2.set_description(content[71])
    gpe2.set_save(content[72])
    bed2.set_description(content[73])
    bed2.set_save(content[74])
    bed3.set_description(content[75])
    bed3.set_save(content[76])
    bed4.set_description(content[77])
    bed4.set_save(content[78])
    bed5.set_description(content[79])
    bed5.set_save(content[80])
